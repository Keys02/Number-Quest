...
function guessNumber(guessedNum){
    if(guessedNum == ""){
        dexterDorkmanImg.setAttribute("src","./assets/images/Dexter_Dorkman_enter_a_number.png")
        guessInput.select()
            return
        }
    ...
    if(difficultyLevels["easy"].selected == true){
       ...
       if(guessedNum==dexterDorkmanNum["easyDifficultyLevel"]){
           setTimeout(function(){
            dexterDorkmanImg.setAttribute("src","./assets/images/Dexter_Dorkman_processing.png")
        },500)

        setTimeout(function(){
            dexterDorkmanImg.setAttribute("src","./assets/images/Dexter_Dorkman_correct.png")
        },1500)
        ...
        setTimeout(function(){
           ...
           setTimeout(function(){
            ...
            setTimeout(function(){
                dexterDorkmanImg.setAttribute("src","./assets/images/Dexter_Dorkman_too_high.png")
                guessInput.value = ""
                guessInput.select()
            },1500)
           ...
           setTimeout(function(){
            ...
            setTimeout(function(){
                dexterDorkmanImg.setAttribute("src","./assets/images/Dexter_Dorkman_too_low.png")
                guessInput.value = ""
                guessInput.select()
            },1500)
    ...
    function startGame(){
        ...
        setTimeout(function(){
            dexterDorkmanImg.setAttribute("src", "./assets/images/Dexter_Dorkman_introduction.png")
        },1500)
    
        setTimeout(function(){
        if(difficultyLevels["easy"].selected == true){
            dexterDorkmanImg.setAttribute("src","./assets/images/Dexter_Dorkman_1-20.png")
        }
    
        if(difficultyLevels["medium"].selected == true){
            dexterDorkmanImg.setAttribute("src","./assets/images/Dexter_Dorkman_1-50.png")
        }
    
        if(difficultyLevels["hard"].selected == true){
            dexterDorkmanImg.setAttribute("src","./assets/images/Dexter_Dorkman_1-100.png")
        }
        },4000)
